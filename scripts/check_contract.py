...
def main():
    ...
    print(json.dumps({'status':'PASS','runtime_version':__version__,'contract_version':CONTRACT_VERSION,'contract_sha256':admission['contract_sha256'],'pre_admission_allowlist':admission['pre_admission_allowlist'],'simulation_selector':'sha256-stable-roundrobin-v2'},indent=2))
    return 0
