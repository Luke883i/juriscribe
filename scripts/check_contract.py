...
def main():
    ...
    for required in ['python -m unittest discover -s tests -v','python scripts/check_contract.py','python scripts/simulate_v5.py --cases 400000','python scripts/reflect_v5.py --target 1000']:
    ...
    print(json.dumps({'status':'PASS','runtime_version':__version__,'contract_version':CONTRACT_VERSION,'contract_sha256':admission['contract_sha256'],'pre_admission_allowlist':admission['pre_admission_allowlist']},indent=2))
    return 0
