...
def evaluate_completion(state):
    """Final v0.9.7 boundary: all generated evidence must converge before delivery."""
        ...
        state.interaction = {
            **(state.interaction or {}),
            "card": interaction_card(
                ...
                summary="Configurazione, originalità, contenuto materializzato, controlli scientifici e copertura completa degli artefatti devono convergere allo stesso fixed point prima della consegna.",
                blocking=True,
            ),
            "status": "READY",
        }
