...
def evaluate_completion(state):
    """Final delivery boundary with runtime-owned standard DOCX materialization."""
        ...
        state.interaction = {
            **(state.interaction or {}),
            "card": interaction_card(
                ...
                summary="Pipeline conversazionale, artefatti standard runtime-owned, tracciabilità del nuovo capitolo, originalità, controlli scientifici e allegati DOCX in coda chat devono convergere allo stesso fixed point prima della consegna.",
                blocking=True,
            ),
            "status": "READY",
        }
